...
const Careers = () => {
  ...
  return (  
    <div className='careers'> 
      ...
      <p className='careers-description1'> Join our dynamic team at Ratis info tech and embark on an exciting journey in the tech world. <br/>Whether you're an experienced professional looking to take the nest step in your career or a fresh graduate eager to kickstart your journey in the tech industry, we have a variety of career options to suit your skills and aspirations.
